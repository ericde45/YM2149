...
; - SID-Voice
;	- on applique une onde carr�e de volume sur une onde carr�e binaire...
...
; lin2logtab
	ldr		R0,pointeur_FIN_DATA_actuel
	mov		R12,R0								; R12=debut de la memoire allou�e
...
; SIDstop  : stop tous les sid par d�faut
...
; par défaut on utilise l'enveloppe comme table de volume ( le digidrum se met dans l'enveloppe)
	...
	moveq	R0,#0				; pas d'enveloppe utilis�e
...
;	1 1 1 1 : Sync Buzzer voice C
	;mov		R4,#0									; mis a z�ro lors de la fin de la lecture du digidrum, test sur l'offset lors du mixage du DG
...
; Sid onde carr�e sur registre 1
;   Sid sur YM6
...
; ---------------------------- YM6 SID Registre 3 --------------------------------------------------------
	...
	and		R1,R1,#0b0011							; bits 5 4 de R3 = voix concern�e
	
; Sid onde carr�e sur registre 3
;   Sid sur YM6
...
YM6packed:
	...
	;.incbin			"Ooh Crikey - loader.ym"							; YM5 noise des le d�but
	...
	;.incbin		"Synergy Credits.ym"									; SID probl�matique YM6
